...
public class Pixel implements Comparable<Pixel> {
    ...
    /**
     * Creates the instance variables of the r, g, b colors
     */
    private int red;
    ...
    public Pixel(int[] c) {
        if (c == null) {
            ...
            this.red = getReal(c[0]);
            this.green = getReal(c[1]);
            this.blue = getReal(c[2]);
        } else if (c.length == 0) {
            this.red = 0;
            this.green = 0;
            this.blue = 0;
    ...
    public int[] getComponents() {
        int[] components = new int[] { red, green, blue };
        return components;
    }
    ...
    public int distance(Pixel px) {
        if (px == null) {
            ...
            return Math.abs(px.getRed() - red) + Math.abs(px.getGreen() - 
                    green) + Math.abs(px.getBlue() - blue);
        }
    }
